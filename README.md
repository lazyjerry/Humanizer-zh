...
Humanizer-zh 用來去除文字中的 AI 生成痕跡，讓內容讀起來像人寫的。適用於：
- 編輯、審閱 AI 生成的內容
- 學習辨認 AI 寫作的常見套路
...
翻譯時做了一些調整：英文的某些模式（如標題大小寫）在中文裡意義不同，範例也換成了中文語境下的寫法。
...
這個工具的目的是提升寫作品質，不是騙過 AI 偵測器。想去掉 AI 味，最有效的方法就是讓文字帶上真實的思考痕跡。
